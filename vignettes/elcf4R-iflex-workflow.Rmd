...
rbind(
  gam = unlist(elcf4r_metrics(test_long$y, pred_gam)),
  mars = unlist(elcf4r_metrics(test_long$y, pred_mars)),
  kwf = unlist(elcf4r_metrics(test_long$y, pred_kwf))
)
```
...
unlist(elcf4r_metrics(test_long$y, pred_lstm))
```
...
In the current build these results cover `gam`, `mars`, `kwf` and `lstm`.
